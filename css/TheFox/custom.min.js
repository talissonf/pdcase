var j$=jQuery;j$.noConflict();"use strict";j$(document).ready(function(){j$('body').jpreLoader();setInterval(vc_check,100);ie_style_fix();set_superfish();set_fixednav();set_center_logo();set_searchform();generate_fw_sections();generate_fwc_sections();setInterval(fixHeight,500);fixSubMenu();setInterval(woo_fix,100);set_alertbtn();set_zillalikes();set_thefox_fix();toTopBind();set_breadcrumbs();load_flex();load_prettyphoto();set_tiptip();set_tabs();set_progress_bar_chart();thefox_animation();set_mobilemenu();mobile_menu_position();set_parallax();});j$(window).resize(function(){generate_fw_sections();generate_fwc_sections();fixSubMenu();set_mobilemenu_btn();mobile_menu_position();set_parallax();});j$(window).scroll(function(){opacity_scroll();});function vc_check(){var fw_fd=j$('#fw_c > .vc_row:first-child');var fw_pt=j$('#fw_c > .vc_row:first-child').css('padding-top');if(!j$("#fw_c > .vc_row:first-child").hasClass('full-width-content')&&fw_pt=='0px'||fw_pt=='0'||fw_pt==''){fw_fd.css('padding-top','100px');}var iefw_fd=j$('#fw_c > .vc_ie-flexbox-fixer > .vc_row:first-child');var iefw_pt=j$('#fw_c > .vc_ie-flexbox-fixer >.vc_row:first-child').css('padding-top');if(j$("#fw_c").children().first().hasClass("vc_ie-flexbox-fixer")){if(!j$("#fw_c > .vc_ie-flexbox-fixer >.vc_row:first-child").hasClass('full-width-content')&&iefw_pt=='0px'||iefw_pt=='0'||iefw_pt==''){iefw_fd.css('padding-top','100px');}}j$('li').next('br').remove();j$('ul').next('br').remove();j$('ul').prev('br').remove();j$("p:empty").css('margin-bottom','0');j$(".wpb_row:empty").remove();j$(".wpb_column:empty").remove();j$(".wpb_wrapper:empty").remove();j$('.vertical').each(function(){var ul_height=j$(this).find('.tabs').height();j$(this).find('.tab_content').css('min-height',ul_height);})}function isIE(){return(navigator.userAgent.toLowerCase().indexOf('msie ')!=-1)||(!!navigator.userAgent.match(/Trident.*rv[:]*11\./));}function ie_style_fix(){if(isIE()){var styles=j$("style").text();j$("style").remove();j$("head").append("<style>"+styles+"</style>");}};function fixHeight(){j$('.full-width-content').each(function(){if(j$(this).find('.vc_column_container').length>1){if(j$(window).width()>748){var maxHeight=0;j$(this).children('.vc_column_container').css('height','auto');j$(this).children('.vc_column_container').each(function(){if(j$(this).outerHeight()>maxHeight){maxHeight=j$(this).outerHeight();}});j$(this).find('#map_canvas').outerHeight(maxHeight);}}});j$('.rd_table_ctn').each(function(){if(j$(this).find('.table_line').length>1){var maxHeight=0;j$(this).find('.table_line').css('height','auto');j$('.table_line').css('min-height','0');j$(this).find('.table_line').each(function(){if(j$(this).outerHeight()>maxHeight){maxHeight=j$(this).outerHeight();j$(this).outerHeight(maxHeight);}else{j$(this).outerHeight(maxHeight);}});j$(this).find('.table_line').outerHeight(maxHeight);}});if(j$(window).width()>768){var p_height=j$("#posts").outerHeight();j$('.business_sidebar').css('min-height',p_height);}else{j$('.business_sidebar').css('min-height',0);}}function set_superfish(){j$('header nav ul').superfish({delay:700,speed:'fast',speedOut:'fast',animation:{opacity:'show'}});j$('.fixed_header_left nav ul').superfish({delay:700,speed:'fast',speedOut:'fast',animation:{opacity:'show'}});j$('.header_bottom_nav nav ul').superfish({delay:700,speed:'fast',speedOut:'fast',animation:{opacity:'show'}});}function toTopBind(){var j$scrollTop=j$(window).scrollTop();if(j$('#to_top').length>0&&j$(window).width()>1034){if(j$scrollTop>350){j$(window).on('scroll',hideToTop);}else{j$(window).on('scroll',showToTop);}}j$('body').on('click','#to_top, a[href="#top"]',function(){j$('body,html').stop().animate({scrollTop:0},800,'easeOutQuad')
return false;});if(!j$('body').hasClass('single-product')){j$('a[href*="#"]:not([href="#"])').click(function(){if(location.pathname.replace(/^\//,'')==this.pathname.replace(/^\//,'')&&location.hostname==this.hostname){var target=j$(this.hash);if(j$('.header_bottom_nav').length>0){var h_height=j$("#header_container").height();}else if(j$(".header_to_shrink").length>0){var h_height="55";}else{var h_height=j$("#header_container").height();}target=target.length?target:$('[name='+this.hash.slice(1)+']');if(target.length){j$('html,body').animate({scrollTop:target.offset().top-h_height},1000);return false;}}});}}function showToTop(){var j$scrollTop=j$(window).scrollTop();if(j$scrollTop>350){j$('#to_top').stop(true,true).animate({'bottom':'30px'},350,'easeInOutCubic');j$(window).off('scroll',showToTop);j$(window).on('scroll',hideToTop);}}function hideToTop(){var j$scrollTop=j$(window).scrollTop();if(j$scrollTop<350){j$('#to_top').stop(true,true).animate({'bottom':'-30px'},350,'easeInOutCubic');j$(window).off('scroll',hideToTop);j$(window).on('scroll',showToTop);}}function set_searchform(){var searchvisible=0;j$("#search-form").focusout(function(){setTimeout(function(){j$("#search-form").removeClass('pop_search_form');j$('#searchtop_img i').removeClass('fa-times');j$('#searchtop_img i').addClass('fa-search');searchvisible=0;},100);})
j$("#searchtop").click(function(e){e.preventDefault();if(searchvisible==0&&j$('#searchtop_img i').hasClass('fa-search')){j$('#searchtop_img i').removeClass('fa-search');j$('#searchtop_img i').addClass('fa-times');j$("#search-form").addClass('pop_search_form');setTimeout(function(){j$('#ssform').focus();},500);searchvisible=1;}else{j$('#searchtop_img i').removeClass('fa-times');searchvisible=0;j$("#search-form").removeClass('pop_search_form');j$('#searchtop_img i').addClass('fa-search');}});}function fixSubMenu(){j$('nav > .sf-js-enabled > li:not(.rd_megamenu)').mouseover(function(){var wapoMainWindowWidth=j$(window).width();var subMenuExist=j$(this).find('.menu-item-has-children').length;if(subMenuExist>0){var subMenuWidth=j$(this).children('.sub-menu').width();var subMenuOffset=j$(this).children('.sub-menu').parent().offset().left+subMenuWidth;if((subMenuOffset+subMenuWidth)>wapoMainWindowWidth){var newSubMenuPosition=subMenuWidth;j$(this).addClass('left_side_menu');}else{var newSubMenuPosition=subMenuWidth;j$(this).removeClass('left_side_menu');}}});j$('.rd_megamenu a').on('mouseenter mouseleave',function(){j$('.rd_megamenu ul').each(function(){if(j$(this).find('.mm_widget_area').length>1){var maxHeight=0;j$(this).children('.mm_widget_area').css('min-height','auto');j$('.mm_widget_area').css('min-height','0');j$(this).children('.mm_widget_area').each(function(){if(j$(this).height()>maxHeight){maxHeight=j$(this).height();}j$(this).css("min-height",maxHeight);})
j$(this).children('.mm_widget_area').css("min-height",maxHeight);}});});}function generate_fw_sections(){var j$fw_width;var j$width=j$(window).width();var j$padding_left='40px';var j$padding_right='40px';var j$margin_left='-35px';if(j$('#boxed_layout').hasClass('menu_slide')){j$fw_width=parseInt(j$('.menu_slide').width());if(j$width<1200){var j$margin_left='-30px';var j$padding_left='30px';var j$padding_right='30px';var j$fw_width=j$fw_width+20;}if(j$width<738){var j$margin_left='-10px';var j$padding_left='10px';var j$padding_right='10px';var j$fw_width=j$fw_width+40;}j$('.full-width-section').each(function(){if(j$('body').hasClass('rtl')){j$(this).css({'margin-right':j$margin_left,'padding-left':j$padding_left,'padding-right':j$padding_right,'margin-left':'0px','width':j$fw_width-80,'visibility':'visible'});}else{j$(this).css({'margin-left':j$margin_left,'padding-left':j$padding_left,'padding-right':j$padding_right,'margin-right':'0px','width':j$fw_width-80,'visibility':'visible'});}});}else if(j$('header').hasClass('fixed_header_left')){j$fw_width=((j$('.menu_slide').width()-parseInt(j$('.section_wrapper').width()))/2)+1;j$('.full-width-section').each(function(){if(j$('body').hasClass('rtl')){j$(this).css({'margin-right':-j$fw_width,'padding-left':j$fw_width,'padding-right':j$fw_width,'visibility':'visible','width':'100%','margin-left':'0px'});}else{j$(this).css({'margin-left':-j$fw_width,'padding-left':j$fw_width,'padding-right':j$fw_width,'visibility':'visible','width':'100%','margin-right':'0px'});}});}else{j$fw_width=((j$(window).width()-parseInt(j$('.section_wrapper').width()))/2)+1;var j$width=j$(window).width();j$('.full-width-section').each(function(){if(j$('body').hasClass('rtl')){j$(this).css({'margin-right':-j$fw_width,'padding-left':j$fw_width,'padding-right':j$fw_width,'visibility':'visible','width':'100%','margin-left':'0px'});}else{j$(this).css({'margin-left':-j$fw_width,'padding-left':j$fw_width,'padding-right':j$fw_width,'visibility':'visible','width':'100%','margin-right':'0px'});}});}}function generate_fwc_sections(){var j$fw_width;var j$width=j$(window).width();var j$padding_left='0px';var j$padding_right='0px';var j$margin_left='-35px';if(j$('#boxed_layout').hasClass('menu_slide')){j$fw_width=parseInt(j$('.menu_slide').width());if(j$width<1200){var j$margin_left='-30px';;}if(j$width<738){var j$margin_left='-10px';}j$('.full-width-content').each(function(){if(j$('body').hasClass('rtl')){j$(this).css({'margin-right':j$margin_left,'padding-left':j$padding_left,'padding-right':j$padding_right,'margin-left':'0px','width':j$fw_width,'visibility':'visible'});}else{j$(this).css({'margin-left':j$margin_left,'padding-left':j$padding_left,'padding-right':j$padding_right,'margin-right':'0px','width':j$fw_width,'visibility':'visible'});}});}else if(j$('header').hasClass('fixed_header_left')){j$fw_width=((j$('.menu_slide').width()-parseInt(j$('.section_wrapper').width()))/2);j$width=j$('.menu_slide').width();j$('.full-width-content').each(function(){if(j$('body').hasClass('rtl')){j$(this).css({'margin-right':-j$fw_width,'padding-left':0,'padding-right':0,'visibility':'visible','width':j$width,'margin-left':'0px'});}else{j$(this).css({'margin-left':-j$fw_width,'padding-left':0,'padding-right':0,'visibility':'visible','width':j$width,'margin-right':'0px'});}});}else{j$fw_width=((j$(window).width()-parseInt(j$('.section_wrapper').width()))/2);var j$width=j$(window).width();j$('.full-width-content').each(function(){if(j$('body').hasClass('rtl')){j$(this).css({'margin-right':-j$fw_width,'padding-left':0,'padding-right':0,'visibility':'visible','width':j$width,'margin-left':'0px'});}else{j$(this).css({'margin-left':-j$fw_width,'padding-left':0,'padding-right':0,'visibility':'visible','width':j$width,'margin-right':'0px'});}});}j$('.row_top_icon').each(function(){j$(this).parent('.vc_row-fluid').css('overflow','visible');});j$('.row_bottom_arrow').each(function(){j$(this).parent('.vc_row-fluid').css('overflow','visible');});}function parallaxRowsBGSet(){j$('.rd_parallax_section').each(function(){var bg=j$(this).css('background-image');j$(this).find('.parallax_bg').css({'background-image':bg});});}function parallaxRowsBGCals(){j$('.rd_parallax_section').each(function(){j$(this).find('.parallax_bg').css({'height':j$(this).outerHeight(true)*2.5,'margin-top':'-'+(j$(this).outerHeight(true)*2.5)/2+'px'});});}window.requestAnimationFrame=window.requestAnimationFrame||window.mozRequestAnimationFrame||window.webkitRequestAnimationFrame||window.msRequestAnimationFrame||function(f){setTimeout(f,1000/60)}
var j$window=j$(window);var windowHeight=j$window.height();j$window.unbind('scroll.parallaxSections').unbind('resize.parallaxSections');j$window.unbind('resize.parallaxSectionsUpdateHeight');j$window.unbind('load.parallaxSectionsOffsetL');j$window.unbind('resize.parallaxSectionsOffsetR');j$window.on('resize.parallaxSectionsUpdateHeight',psUpdateWindowHeight);function psUpdateWindowHeight(){windowHeight=j$window.height();}function psUpdateOffset(j$this){j$this.each(function(){firstTop=j$this.offset().top;});}j$.fn.parallaxScroll=function(xpos,speedFactor,outerHeight){var j$this=j$(this);var getHeight;var firstTop;var paddingTop=0;j$this.each(function(){firstTop=j$this.offset().top;});j$window.on('resize.parallaxSectionsOffsetR',psUpdateOffset(j$this));j$window.on('load.parallaxSectionsOffsetL',psUpdateOffset(j$this));getHeight=function(jqo){return jqo.outerHeight(true);};if(arguments.length<1||xpos===null)xpos="50%";if(arguments.length<2||speedFactor===null)speedFactor=0.1;if(arguments.length<3||outerHeight===null)outerHeight=true;var j$element,top,height,pos;function update(){pos=j$window.scrollTop();j$this.each(function(){firstTop=j$this.offset().top;j$element=j$(this);top=j$element.offset().top;height=getHeight(j$element);if(top+height<pos||top>pos+windowHeight){return;}var ua=window.navigator.userAgent;var msie=ua.indexOf("MSIE ");if(msie>0||!!navigator.userAgent.match(/Trident.*rv\:11\./)||navigator.userAgent.indexOf('Safari')!=-1&&navigator.userAgent.indexOf('Chrome')==-1){j$this.find('.parallax_bg').css('backgroundPosition',xpos+" "+Math.round((firstTop-pos)*speedFactor)+"px",0);}else{j$this.find('.parallax_bg').transition({'y':Math.round((firstTop-pos)*speedFactor)+"px"},0);}});}window.addEventListener('scroll',function(){requestAnimationFrame(update);},false)
j$window.on('resize.parallaxSections',update);update();};function set_parallax(){j$('.rd_parallax_section .parallax_wrap').each(function(){var id=j$(this).attr('id');$("#"+id+".parallax_wrap").parallaxScroll("50%",0.2);parallaxRowsBGSet();parallaxRowsBGCals();});}function load_flex(){j$('.flexslider').flexslider({animation:"slide",slideDirection:"horizontal",directionNav:true,start:function(slider){var j$new_height=slider.slides.eq().height();slider.height(j$new_height);},before:function(slider){var j$new_height=slider.slides.eq(slider.animatingTo).height();if(j$new_height!=slider.height()){slider.animate({height:j$new_height},400);}}});}function set_alertbtn(){j$('.alert_del_btn').click(function(){j$(this).parents('div[class^="alert"]').fadeOut(500);});j$('.woocommerce-error:before').click(function(){j$(this).parents('.woocommerce-error').fadeOut(500);});}function woo_fix(){j$('.products').css('opacity','1');j$('.product_list_widget').each(function(){var rightmargin=j$(this).width()-184;j$(this).find('.star-rating').css('margin-right',rightmargin);});}function load_prettyphoto(){j$("a[class^='prettyPhoto']").prettyPhoto();j$("a[class^='prettyphoto']").prettyPhoto();j$("a[rel^='prettyPhoto']").prettyPhoto();j$("a[rel^='prettyphoto']").prettyPhoto();}function opacity_scroll(){var st=j$(this).scrollTop();j$('.opacity_scroll').each(function(index){j$(this).css({'opacity':(1-st/$(this).offset().top)});})}function set_tiptip(){j$(".tagcloud a,.post-title h2 a,.star-rating,.show_review_form.button,.remove,.filter_param_desc,.comments-link,.zilla-likes,.product_list_widget li a").addClass("tiptip");j$(".tiptip").tipTip({maxWidth:"auto",edgeOffset:5});}function set_breadcrumbs(){if(j$(".child_pages_ctn").children('li').length===0){j$("#rd_child_pages").hide();}var childvisible=0;var title_width=j$('.page_title_ctn h1').width()+80;j$(document).on('click',function(e){if(childvisible!==0&&j$('.rd_child_pages').hasClass('child_icon_close')){if(!(e.target.id=='rd_child_pages'||$(e.target).parents('#rd_child_pages').length>0)){j$('.rd_child_pages').removeClass('child_icon_close');childvisible=0;j$(".child_pages_ctn").removeClass('pop_child_pages');j$('.rd_child_pages').addClass('child_closed');}}});j$(".child_pages_ctn").css('width',title_width);j$(".rd_child_pages").click(function(e){if(childvisible==0&&j$('.rd_child_pages').hasClass('child_closed')){j$(".child_pages_ctn").css('width',title_width);j$('.rd_child_pages').removeClass('child_closed');j$('.rd_child_pages').addClass('child_icon_close');j$(".child_pages_ctn").addClass('pop_child_pages');setTimeout(function(){j$('.child_pages_ctn').focus();},1500);childvisible=1;}else{j$('.rd_child_pages').removeClass('child_icon_close');childvisible=0;j$(".child_pages_ctn").removeClass('pop_child_pages');j$('.rd_child_pages').addClass('child_closed');}});}function set_thefox_fix(){j$(".post-attachement").fitVids();j$(".entry").fitVids();j$(".video_sc").fitVids();j$(".textwidget").fitVids();j$('.rd_list_4').each(function(){var n=j$(this).children("div").length;var width=100/n;j$(this).children("div").css("width",width+"%");j$(this).children("div").addClass("rda_flipInY");});j$('.footer_type_3 .widget h2').each(function(){var me=j$(this);me.html(me.text().replace(/(^\w+|\s+\w+)/,'<strong>$1</strong>'));});j$(".cat-item").has("ul").addClass("cat-got-children");j$(".children .cat-item").has("ul").addClass("subcat-got-children");var children=j$(".cat-item .children");children.prev('a').click(function(event){event.preventDefault();j$(this).next('.children').slideToggle();})
j$('.cat-got-children a').click(function(event){if(j$(this).parent('li').hasClass('cat-open')){j$(this).parent('li').removeClass('cat-open');}else{j$(this).parent('li').addClass('cat-open');}})
j$('.subcat-got-children a').click(function(event){if(j$(this).parent('li').hasClass('subcat-open')){j$(this).parent('li').removeClass('subcat-open');}else{j$(this).parent('li').addClass('subcat-open');}})
j$('.subcat-got-children').click(function(event){})}function set_zillalikes(){j$('.zilla-likes').on('click',function(){var link=j$(this);if(link.hasClass('active'))return false;var id=j$(this).attr('id'),postfix=link.find('.zilla-likes-postfix').text();j$.post(zilla_likes.ajaxurl,{action:'zilla-likes',likes_id:id,postfix:postfix},function(data){link.html(data).addClass('active').attr('title','You already like this');});return false;});if(j$('body.ajax-zilla-likes').length){j$('.zilla-likes').each(function(){var id=j$(this).attr('id');j$(this).load(zilla_likes.ajaxurl,{action:'zilla-likes',post_id:id});});}}function set_tabs(){var strHash=document.location.hash;j$('.wpb_accordion_section h3 > a').click(function(){setTimeout(function(){j$(".rd_img_carousel").trigger('updateSizes');j$(".rd_testimonials").trigger('updateSizes');j$(".partners").trigger('updateSizes');j$("ul").trigger('updateSizes');google.maps.event.trigger(window,'resize',{});},800);var target=j$(this);if(j$('.header_bottom_nav').length>0){var h_height=j$("#header_container").height();}else if(j$(".header_to_shrink").length>0){var h_height="55";}else{var h_height="55";}setTimeout(function(){j$('html,body').animate({scrollTop:target.offset().top-h_height},1000);j$(".rd_img_carousel").trigger('updateSizes');j$(".rd_testimonials").trigger('updateSizes');j$(".partners").trigger('updateSizes');j$("ul").trigger('updateSizes');google.maps.event.trigger(window,'resize',{});},400);});j$('.tabs-wrapper').each(function(){var t=1;j$(this).find('.tabli').each(function(){j$(this).find('a').attr('href','#tab'+t);j$(this).parents('.tabs-wrapper').find('.tabs').append(this);t++;});var t=1;j$(this).find('.tab_content').each(function(){j$(this).attr('id','tab'+t);j$(this).parents('.tabs-wrapper').find('.tabs-container').append(this);t++;});j$(this).find(".tab_content").hide();j$(this).find("ul.tabs li:first").addClass("active").show();j$(this).find(".tab_content:first").show();});j$(".tabs-wrapper ul.tabs li").click(function(e){j$(this).parents('.tabs-wrapper').find("ul.tabs li").removeClass("active");j$(this).addClass("active");j$(this).parents('.tabs-wrapper').find(".tab_content").hide();var activeTab=j$(this).find("a").attr("href");j$(this).parents('.tabs-wrapper').find(activeTab).fadeIn();j$(".rd_img_carousel").trigger('updateSizes');j$(".rd_testimonials").trigger('updateSizes');j$(".partners").trigger('updateSizes');j$("ul").trigger('updateSizes');e.preventDefault();j$(".rd_img_carousel").trigger('updateSizes');j$(".rd_testimonials").trigger('updateSizes');j$(".partners").trigger('updateSizes');google.maps.event.trigger(window,'resize',{});j$("ul").trigger('updateSizes');});j$(".woocommerce-tabs .tabs-wrapper ul.tabs li").click(function(e){j$(this).parents('.tabs-wrapper').find("ul.tabs li").removeClass("active");j$(this).addClass("active");j$(this).parents('.tabs-wrapper').find(".tab_content").hide();var activeTab=j$(this).find("a").attr("href");j$(this).parents('.tabs-wrapper').find(activeTab).fadeIn();e.preventDefault();});j$(".tabs-wrapper ul.tabs li a").click(function(e){e.preventDefault();j$(".rd_img_carousel").trigger('updateSizes');j$(".rd_testimonials").trigger('updateSizes');j$(".partners").trigger('updateSizes');google.maps.event.trigger(window,'resize',{});j$("ul").trigger('updateSizes');});j$(".woocommerce-tabs ul.tabs li a").click(function(e){e.preventDefault();});if(strHash)j$('.tabli a[href$="'+strHash+'"]').parent().trigger('click');}function mobile_menu_position(){var header_height=j$('header').height();if(!j$('header').hasClass('fixed_header_left')){j$('#header_container').css('min-height',header_height);}if(j$(window).width()<1018){var mobilenav=0;j$("header nav ul,.header_bottom_nav nav ul").hide();j$("#nav_button").show();}if(j$('header').hasClass('fixed_header_left')){if(j$(window).width()<1036){var top_value=0;if(j$('#wpadminbar').length>=1){top_value=j$('#wpadminbar').outerHeight()+"px";}j$('.mt_menu.sticky_header.menu_slide').css({'position':'fixed','top':top_value,'left':0,'width':'100%'});}else{j$('.mt_menu.sticky_header.menu_slide').css({'position':'relative','top':top_value,'left':0,'width':'100%'});}}else{if(j$(window).width()<750){var top_value=0;if(j$('#wpadminbar').length>=1){top_value=j$('#wpadminbar').outerHeight()+"px";}j$('.mt_menu.sticky_header.menu_slide').css({'position':'fixed','top':top_value,'left':0,'width':'100%'});}else{j$('.mt_menu.sticky_header.menu_slide').css({'position':'relative','top':top_value,'left':0,'width':'100%'});}}}function set_mobilemenu_btn(){if(j$(window).width()>1018){j$("#mobile-menu").removeClass('mm_open');j$(".menu_slide").removeClass('slided_body');j$("header nav ul,.header_bottom_nav nav ul").show();j$("header nav ul a,.header_bottom_nav nav ul a").click(function(){j$("header nav ul,.header_bottom_nav nav ul").show();})}if(j$(window).width()<1018){j$("header nav ul,.header_bottom_nav nav ul").hide();j$("#nav_button").show();}if(j$(window).width()<1036&&!j$('header').hasClass('fixed_header_left')){j$("header").css("position","relative");}var m_height=j$("#sidebar").height();j$("#posts").css({minHeight:m_height});}function set_mobilemenu(){j$("<div id='nav_button' />").appendTo("header nav");j$("<div id='nav_button' />").appendTo(".header_bottom_nav nav");j$(document).on("mousedown touchstart",function(e){var container=j$(".mm_open");if(!container.is(e.target)&&container.has(e.target).length===0){j$("#mobile-menu").removeClass('mm_open');j$(".menu_slide").removeClass('slided_body');}});j$("#nav_button").click(function(e){if(j$("#mobile-menu").hasClass('mm_open')){j$("#mobile-menu").removeClass('mm_open');j$(".menu_slide").removeClass('slided_body');}else{j$("#mobile-menu").addClass('mm_open');j$(".menu_slide").addClass('slided_body');}});j$("#close_mm").click(function(e){j$("#mobile-menu").removeClass('mm_open');j$(".menu_slide").removeClass('slided_body');});j$(".page-template-onepage #mobile-menu .menu-item a[href*='#']:not([href='#'])").click(function(e){j$("#mobile-menu").removeClass('mm_open');j$(".menu_slide").removeClass('slided_body');});j$("#nav_button_alt").click(function(e){if(j$("#mobile-menu").hasClass('mm_open')){j$("#mobile-menu").removeClass('mm_open');j$(".menu_slide").removeClass('slided_body');}else{j$("#mobile-menu").addClass('mm_open');j$(".menu_slide").addClass('slided_body');}});j$('#mobile-menu .menu-item-has-children ').click(function(ev){$(this).find('>ul').slideToggle();if($(this).hasClass('mobile-ul-open')){$(this).removeClass('mobile-ul-open');}else{$(this).addClass('mobile-ul-open');}ev.stopPropagation();})}function set_fixednav(){var sticky_navigation_offset_top=j$('.sticky_header').offset().top;var sticky_navigation=function(){var scroll_top=j$(window).scrollTop();if(scroll_top>sticky_navigation_offset_top&&j$('header').hasClass('fixed_header_left')){var top_value=0;if(j$('#wpadminbar').length>=1){var top_value=j$('#wpadminbar').outerHeight()+"px";}j$('.mt_menu.sticky_header.menu_slide').css({'position':'fixed','top':top_value,'left':0,'width':'100%'});}else if(scroll_top>sticky_navigation_offset_top&&j$('#fixed_body_left').length<1){var top_value=0;if(j$('#wpadminbar').length>=1){var top_value=j$('#wpadminbar').outerHeight()+"px";}j$('header.sticky_header').addClass('opaque_header');j$('.header_to_shrink').addClass('shrinked_header');j$('.header_bottom_nav').addClass('opaque_header');j$('header.sticky_header').css({'position':'fixed','top':top_value,'left':0,'width':'100%',"-moz-box-shadow":"0 2px 6px rgba(0,0,0,0.05) !important","-webkit-box-shadow":"0 2px 6px rgba(0,0,0,0.05) !important","box-shadow":"0 2px 6px rgba(0,0,0,0.05) !important"});j$('.header_bottom_nav.sticky_header').css({'position':'fixed','top':top_value,'left':0,'width':'100%'});j$('.mt_menu.sticky_header.menu_slide').css({'position':'fixed','top':top_value,'left':0,'width':'100%'});if(j$(window).width()<1036){j$("header.sticky_header").css("position","relative");j$(".header_bottom_nav.sticky_header").css("position","relative");}}else{j$('header').removeClass('opaque_header');j$('.header_to_shrink').removeClass('shrinked_header');j$('.header_bottom_nav').removeClass('opaque_header');j$('header.sticky_header').css({'top':0,'position':'relative',"-moz-box-shadow":"0 2px 6px rgba(0,0,0,0.05) !important","-webkit-box-shadow":"0 2px 6px rgba(0,0,0,0.05) !important","box-shadow":"0 2px 6px rgba(0,0,0,0.05) !important"});j$('.header_bottom_nav.sticky_header').css({'position':'relative','top':0});if(j$(window).width()>750){j$('.mt_menu.sticky_header.menu_slide').css({'position':'relative','top':top_value,'left':0,'width':'100%'});}}};sticky_navigation();j$(window).scroll(function(){sticky_navigation();});}if(j$(window).width()<1036&&!j$('header').hasClass('fixed_header_left')){j$("header").css("position","relative");}function set_center_logo(){var total_menu_items=j$('.nav_type_9_c > ul > li').length;var half_position_even=total_menu_items/2;var half_position_odd=(total_menu_items+1)/2;var ex=/^\d+$/;if(ex.test(total_menu_items/2)){j$('.nav_type_9_c > ul > li:nth-child('+half_position_even+')').addClass('cl_before_logo');j$('.nav_type_9_c > ul > li:nth-child('+(half_position_even+1)+')').addClass('cl_after_logo');}else{j$('.nav_type_9_c > ul > li:nth-child('+half_position_odd+')').addClass('cl_before_logo');j$('.nav_type_9_c > ul > li:nth-child('+(half_position_odd+1)+')').addClass('cl_after_logo');}}function set_progress_bar_chart(){j$('.rd_pb_holder').waypoint(function(){j$(this).find('.progress_bar_sc').each(function(index){var j$this=j$(this),bar=j$this.find('.pb_bg'),bar_stripe=j$this.find('.pb_stripe'),val=bar.data('percentage-value');setTimeout(function(){bar.css({"width":val+'%'});bar_stripe.css({"width":val+'%'});},index*200);});},{offset:'85%'});j$('.rd_pie_01').waypoint(function(){var x=260;var y=200;var r=154;var linewidth=22;var SET_PERCENTAGE=j$(this).children('.rd_pc_01').data('percentage-value');var bar_color=j$(this).children('.rd_pc_01').data('bar-color');var alt_color=j$(this).children('.rd_pc_01').data('bar-alt-color');var c=j$(this).children('.rd_pc_01').get(0);var id=j$(this).attr('id');var status=j$('#'+id+'.rd_pc_status');var loaded=false;window.onload=function(){loaded=true;}
var ROTATION=0;function setcanvas(){var ctx=c.getContext("2d");ctx.translate(x,y);ctx.rotate((Math.PI/180)*(-ROTATION));ctx.translate(-x,-y);ctx.clearRect(0,0,c.width,c.height);ctx.beginPath();ctx.lineWidth=4;ctx.strokeStyle=track_color;ctx.arc(x,y,r,0,2*Math.PI);ctx.stroke();}function getPoint(c1,c2,radius,angle){return[c1+Math.cos(angle)*radius,c2+Math.sin(angle)*radius];}function setPercent(uplimit){var ctx=c.getContext("2d");ctx.beginPath();ctx.translate(x,y);ROTATION=270;ctx.rotate((Math.PI/180)*ROTATION);ctx.translate(-x,-y);ctx.lineWidth=4;var my_gradient=ctx.createLinearGradient(-0,0,0,340);my_gradient.addColorStop(0,bar_color);my_gradient.addColorStop(1,alt_color);ctx.strokeStyle=my_gradient;ctx.arc(x,y,r,(Math.PI/180)*(uplimit),0);ctx.stroke();ctx.beginPath();var a=getPoint(x,y,r,(Math.PI/180)*(uplimit))[0];var b=getPoint(x,y,r,(Math.PI/180)*(uplimit))[1];nr=7;ctx.arc(a,b,nr,0,2*Math.PI);ctx.lineWidth=4;ctx.fillStyle=track_color;ctx.fill();ctx.fillStyle=bar_color;ctx.stroke();}function callcanvas(degree){setcanvas();setPercent(360-degree);}var degree=parseInt((SET_PERCENTAGE*360)/100);var start=0;var it=window.setInterval(function(){callcanvas(start);start++;if(start==degree){start=degree;window.clearInterval(it);}if(loaded)status.html(parseInt((start*100)/360)+'%');},1);j$(this).children('.rd_pc_04').removeClass('rd_pc_04');},{offset:'85%'});j$('.rd_pie_05').waypoint(function(){var x=260;var y=200;var r=160;var linewidth=80;var SET_PERCENTAGE=j$(this).children('.rd_pc_05').data('percentage-value');var bar_color=j$(this).children('.rd_pc_05').data('bar-color');var alt_color=j$(this).children('.rd_pc_05').data('bar-alt-color');var track_color=j$(this).children('.rd_pc_05').data('track-color');var ball_color=j$(this).children('.rd_pc_05').data('ball-color');var c=j$(this).children('.rd_pc_05').get(0);var id=j$(this).attr('id');var status=j$('#'+id+'.rd_pc_status');var loaded=false;var ctx=c.getContext("2d");window.onload=function(){loaded=true;}
var ROTATION=0;function setcanvas(){ctx.translate(x,y);ctx.rotate((Math.PI/180)*(-ROTATION));ctx.translate(-x,-y);ctx.clearRect(0,0,c.width,c.height);ctx.beginPath();ctx.lineWidth=80;ctx.strokeStyle=track_color;ctx.arc(x,y,r,0,2*Math.PI);ctx.stroke();ctx.beginPath();ctx.lineWidth=4;ctx.strokeStyle="black";ctx.arc(x,y,r+(linewidth/2),0,2*Math.PI);ctx.globalAlpha=0.02;ctx.stroke();ctx.beginPath();ctx.lineWidth=4;ctx.strokeStyle="black";ctx.arc(x,y,r-(linewidth/2),0,2*Math.PI);ctx.stroke();}function getPoint(c1,c2,radius,angle){return[c1+Math.cos(angle)*radius,c2+Math.sin(angle)*radius];}function setPercent(uplimit){ctx.beginPath();ctx.translate(x,y);ROTATION=270;ctx.rotate((Math.PI/180)*ROTATION);ctx.translate(-x,-y);ctx.lineWidth=linewidth;var my_gradient=ctx.createLinearGradient(-0,0,0,520);my_gradient.addColorStop(0,bar_color);my_gradient.addColorStop(1,alt_color);ctx.strokeStyle=my_gradient;ctx.arc(x,y,r,(Math.PI/180)*(uplimit),0);ctx.globalAlpha=1;ctx.stroke();ctx.beginPath();var a=getPoint(x,y,r,(Math.PI/180)*(uplimit))[0];var b=getPoint(x,y,r,(Math.PI/180)*(uplimit))[1];nr=linewidth/2;ctx.lineWidth=2;ctx.strokeStyle=track_color;ctx.arc(a,b,nr,0,2*Math.PI);ctx.fillStyle=track_color;ctx.fill();ctx.stroke();ctx.beginPath();var a=getPoint(x,y,r,(Math.PI/180)*(uplimit))[0];var b=getPoint(x,y,r,(Math.PI/180)*(uplimit))[1];nr=linewidth/2-6;ctx.lineWidth=14;ctx.strokeStyle=track_color;ctx.arc(a,b,nr,0,2*Math.PI);ctx.fillStyle=ball_color;ctx.fill();ctx.stroke();}function callcanvas(degree){setcanvas();setPercent(360-degree);}var degree=parseInt((SET_PERCENTAGE*360)/100);var start=0;var it=window.setInterval(function(){callcanvas(start);start++;if(start==degree){start=degree;window.clearInterval(it);}if(loaded)status.html(parseInt((start*100)/360)+'%');},1);j$(this).children('.rd_pc_05').removeClass('rd_pc_05');},{offset:'85%'});j$('.count_sc').each(function(){var countAsset=j$(this),countNumber=countAsset.find('.count_number'),countDivider=countAsset.find('.count_line').find('span'),countSubject=countAsset.find('.count_title');countNumber.countTo({onComplete:function(){countDivider.animate({'width':50},400,'easeOutCubic');countSubject.delay(100).animate({'opacity':1,'bottom':'0px'},600,'easeOutCubic');}});});}function thefox_animation(){(function(j$){j$.fn.visible=function(partial){var j$t=j$(this),j$w=j$(window),viewTop=j$w.scrollTop(),viewBottom=viewTop+j$w.height(),_top=j$t.offset().top+100,_bottom=_top+j$t.height(),compareTop=partial===true?_bottom:_top,compareBottom=partial===true?_top:_bottom;return((compareBottom<=viewBottom)&&(compareTop>=viewTop));};})(jQuery);var win=j$(window);var allMods=j$(".rda_opacity,.rda_toleft,.rda_toright,.rda_totop,.rda_tobottom,.rd_chart_black,.rd_chart_white,.rda_fadeIn,.rda_fadeInDown,.rda_fadeInUp,.rda_fadeInLeft,.rda_fadeInRight,.rda_bounceIn,.rda_bounceInDown,.rda_bounceInUp,.rda_bounceInLeft,.rda_bounceInRight,.rda_zoomIn,.rda_flipInX,.rda_flipInY,.rda_bounce,.rda_flash,.rda_shake,.rda_pulse,.rda_swing,.rda_rubberBand,.rda_wobble,.rda_tada");var count=j$(".rd_count_to");allMods.each(function(i,el){var el=j$(el);if(el.visible(true)){el.addClass("already-visible");}});count.each(function(i,el){var el=j$(el);if(el.visible(true)){var countAsset=j$(this),countNumber=countAsset.find('.count_number'),countDivider=countAsset.find('.count_line').find('span'),countSubject=countAsset.find('.count_title');el.removeClass("rd_count_to");el.addClass("rd_count_to_over");countNumber.countTo({onComplete:function(){countDivider.animate({'width':50},400,'easeOutCubic');countSubject.delay(100).animate({'opacity':1,'bottom':'0px'},600,'easeOutCubic');}});}});win.scroll(function(event){j$(".rda_opacity").each(function(i,el){var el=j$(el);if(el.visible(true)){setTimeout(function(){el.addClass('opacity_ani');},50*i);}});j$(".rda_toleft").each(function(i,el){var el=j$(el);if(el.visible(true)){el.addClass("toleft_ani");}});j$(".rda_toright").each(function(i,el){var el=j$(el);if(el.visible(true)){el.addClass("toright_ani");}});j$(".rda_totop").each(function(i,el){var el=j$(el);if(el.visible(true)){setTimeout(function(){el.addClass('totop_ani');},50*i);}});j$(".rda_tobottom").each(function(i,el){var el=j$(el);if(el.visible(true)){el.addClass("tobottom_ani");}});j$(".rda_fadeIn").each(function(i,el){var el=j$(el);if(el.visible(true)){setTimeout(function(){el.addClass('animated fadeIn');},50*i);}});j$(".rda_fadeInDown").each(function(i,el){var el=j$(el);if(el.visible(true)){setTimeout(function(){el.addClass('animated fadeInDown');},50*i);}});j$(".rda_fadeInUp").each(function(i,el){var el=j$(el);if(el.visible(true)){setTimeout(function(){el.addClass('animated fadeInUp');},50*i);}});j$(".rda_fadeInLeft").each(function(i,el){var el=j$(el);if(el.visible(true)){setTimeout(function(){el.addClass('animated fadeInLeft');},50*i);}});j$(".rda_fadeInRight").each(function(i,el){var el=j$(el);if(el.visible(true)){setTimeout(function(){el.addClass('animated fadeInRight');},50*i);}});j$(".rda_bounceIn").each(function(i,el){var el=j$(el);if(el.visible(true)){setTimeout(function(){el.addClass('animated bounceIn');},50*i);}});j$(".rda_bounceInDown").each(function(i,el){var el=j$(el);if(el.visible(true)){setTimeout(function(){el.addClass('animated bounceInDown');},50*i);}});j$(".rda_bounceInUp").each(function(i,el){var el=j$(el);if(el.visible(true)){setTimeout(function(){el.addClass('animated bounceInUp');},50*i);}});j$(".rda_bounceInLeft").each(function(i,el){var el=j$(el);if(el.visible(true)){setTimeout(function(){el.addClass('animated bounceInLeft');},50*i);}});j$(".rda_bounceInRight").each(function(i,el){var el=j$(el);if(el.visible(true)){setTimeout(function(){el.addClass('animated bounceInRight');},50*i);}});j$(".rda_zoomIn").each(function(i,el){var el=j$(el);if(el.visible(true)){setTimeout(function(){el.addClass('animated zoomIn');},50*i);}});j$(".rda_flipInX").each(function(i,el){var el=j$(el);if(el.visible(true)){setTimeout(function(){el.addClass('animated flipInX');},50*i);}});j$(".rda_flipInY").each(function(i,el){var el=j$(el);if(el.visible(true)){setTimeout(function(){el.addClass('animated flipInY');},50*i);}});j$(".rda_bounce").each(function(i,el){var el=j$(el);if(el.visible(true)){setTimeout(function(){el.addClass('animated bounce');},50*i);}});j$(".rda_flash").each(function(i,el){var el=j$(el);if(el.visible(true)){setTimeout(function(){el.addClass('animated flash');},50*i);}});j$(".rda_shake").each(function(i,el){var el=j$(el);if(el.visible(true)){setTimeout(function(){el.addClass('animated shake');},50*i);}});j$(".rda_pulse").each(function(i,el){var el=j$(el);if(el.visible(true)){setTimeout(function(){el.addClass('animated pulse');},50*i);}});j$(".rda_swing").each(function(i,el){var el=j$(el);if(el.visible(true)){setTimeout(function(){el.addClass('animated swing');},50*i);}});j$(".rda_rubberBand").each(function(i,el){var el=j$(el);if(el.visible(true)){setTimeout(function(){el.addClass('animated rubberBand');},50*i);}});j$(".rda_wobble").each(function(i,el){var el=j$(el);if(el.visible(true)){setTimeout(function(){el.addClass('animated wobble');},50*i);}});j$(".rda_tada").each(function(i,el){var el=j$(el);if(el.visible(true)){setTimeout(function(){el.addClass('animated tada');},50*i);}});j$(".rd_count_to").each(function(i,el){var el=j$(el);if(el.visible(true)){var countAsset=j$(this),countNumber=countAsset.find('.count_number'),countDivider=countAsset.find('.count_line').find('span'),countSubject=countAsset.find('.count_title');el.removeClass("rd_count_to");el.addClass("rd_count_to_over");countNumber.countTo({onComplete:function(){countDivider.animate({'width':50},400,'easeOutCubic');countSubject.delay(100).animate({'opacity':1,'bottom':'0px'},600,'easeOutCubic');}});}});});}(function($){"use strict";var items=new Array(),errors=new Array(),onComplete=function(){},current=0;var jpreOptions={splashVPos:'35%',loaderVPos:'0%',splashID:'#jpreContent',showSplash:true,showPercentage:true,autoClose:true,closeBtnText:'Start!',onetimeLoad:false,debugMode:false,splashFunction:function(){}}
var jOverlay=$('#jpreOverlay');var jBar=$('#jpreBar');var jPer=$('#jprePercentage');var getCookie=function(){if(jpreOptions.onetimeLoad){var cookies=document.cookie.split('; ');for(var i=0,parts;(parts=cookies[i]&&cookies[i].split('='));i++){if((parts.shift())==="jpreLoader"){return(parts.join('='));}}return false;}else{return false;}}
